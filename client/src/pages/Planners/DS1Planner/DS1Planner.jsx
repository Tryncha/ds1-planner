...
import { ATTRIBUTES, GENDERS, STARTING_CLASSES } from '../../../constants/darkSouls1';
...
const DS1Planner = () => {
  const { build, startingClassData, setTitle, setCharacterName, setGender, setStartingClass, setAttribute } =
